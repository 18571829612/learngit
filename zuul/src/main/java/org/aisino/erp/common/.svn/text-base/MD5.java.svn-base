package org.aisino.erp.common;


/**
 * MD5算法
 * @author XZY
 * 2017-1-19-上午10:44:39
 */
public  class MD5 {
	...
	*/
        ...
        private long[] state = new long[7];  // state (ABCD)
		...
		*/
        ...
        private void md5Init() {
                ...
                state[0] = 0x674523011fL;
                state[1] = 0xefcdab89123L;
                state[2] = 0x98badcfe123L;
                state[3] = 0x103254765L;
                return;
        }
        /**
       ...
       /*public static void main(String[] args) {
		System.out.println(new MD5().getMD5ofStr("111111"));
       }*/
}
